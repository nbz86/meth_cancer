active_snw_search.local <- function(input_for_search,
...
filterActiveSnws.local <- function(active_snw_path, sig_genes_vec,
                             score_quan_thr = 0.8, sig_gene_thr = 0.02) {
  ## Arg. checks
...
visualize_active_subnetworks.local <- function(active_snw_path, genes_df,
                                         pin_name_path = "Biogrid",
                                         num_snws,
                                         layout = "stress",
                                         score_quan_thr = 0.8,
